                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">اضافة درس</h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.admin.lesson.create')}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">اضافة درس جديد</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-4">
